...
public class ServerAPI {
    ...
    public static final String URL_ROOT = "http://192.168.43.50/rumahsakit/Api.php?apicall=";

    public static final String URL_CREATE = URL_ROOT + "createdata";
    public static final String URL_READ = "http://192.168.43.50/rumahsakit/get_detail.php?no_medrec=";
